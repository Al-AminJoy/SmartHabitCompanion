    ...
    Surface(modifier = Modifier.fillMaxSize()) {
        ...
        Column(modifier = Modifier.fillMaxSize()) {
            ...
            if (uiState.weather != null) {
                WeatherInfo(weather = uiState.weather!!, modifier = Modifier.fillMaxWidth().padding(
        ...
        Row (){
            ...
            Box(modifier = Modifier.size(80.dp), contentAlignment = Alignment.Center) {
                if (weather.icon != null) {
                    AsyncImage(
                        model = buildImageRequest(weather.icon),
            ...
            Column {
                Text(text = "${weather.temperature} \u00B0C", style = MaterialTheme.typography.bodyMedium)
                Text(text = weather.city, style = MaterialTheme.typography.bodySmall)
